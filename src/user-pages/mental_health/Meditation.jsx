          ...
          >
            ...
            <CardActions sx={{ margin: "15px" }}>
              <ul className="links-a-tag">
                ...
                >
                  {/* <a href="#">Easier to Start</a> */}
                  <Link to="/src/Meditation-Pages/Easier_to_start">Easier to start</Link>
                </li>
                <li
                  style={{
                    marginBottom: "1.5rem",
                ...
                >
                  {/* <a href="#">Focus and Clarity</a> */}
                  <Link to="/src/Meditation-Pages/Focus_and_Clarity">Focus and Clarity</Link>
                </li>
                <li
                  style={{
                    marginBottom: "1.5rem",
                ...
                >
                  {/* <a href="#">Improved Emotional Wellbeing</a> */}
                  <Link to="/src/Meditation-Pages/Improved_Emotional_Wellbeing">Improved Emotional Wellbeing</Link>
                </li>
                <li
                  style={{
                    marginBottom: "1.5rem",
                ...
                >
                  {/* <a href="#">Increased Self-Awareness</a> */}
                  <Link to="/src/Meditation-Pages/Increased_Self_Awareness">Increased Self-Awareness</Link>
                </li>
                <li
                  style={{
                    marginBottom: "1.5rem",
                ...
                >
                  ...
                  <Link to="/src/Meditation-Pages/Expert_Guidance">Expert Guidance</Link>
                </li>
              </ul>
            </CardActions>
          </Card>
            ...
            <CardActions sx={{ margin: "15px" }}>
              <ul>
                ...
                >
                  ...
                  <Link to="/src/Meditation-Pages/Body_scan_meditation">Body scan meditation to reduce stress</Link>
                </li>
                <li
                  style={{
                    marginBottom: "1.5rem",
                ...
                >
                  ...
                  <Link to="/src/Meditation-Pages/Gratitude_meditation">Gratitude Meditation</Link>
                </li>
                <li
                  style={{
                    marginBottom: "1.5rem",
